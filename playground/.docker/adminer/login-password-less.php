...
class AdminerLoginPasswordLess
{
    ...
    {
        $this->separator = "__";
		$this->group_translations = true;
		$this->translation_sufixes = ["__translation","_translation","__translations","_translations"];
        if ($_POST["auth"]) {
	...
	function head() {
		...
		<style type="text/css">
			#menu div.line { padding: 0; margin: 5px 0; cursor: pointer; border: none; white-space: nowrap; }
